...
{
    internal partial class Testing_ClientAndEmployeeNumber : Form
    {
        ...
        internal Testing_ClientAndEmployeeNumber()
        {
            InitializeComponent();
            this.WindowState = FormWindowState.Maximized;

            // Ermittlung inkl. Speicherung nächste Mitarbeiter Nr. (1. Lauf)
            ...
            // Ermittlung inkl. Speicherung nächste Kunden Nr. (1. Lauf)
